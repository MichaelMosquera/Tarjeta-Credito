...
CREATE TABLE `historialsolicitud` (
  `idHistoria` int(10) NOT NULL AUTO_INCREMENT,
  `ipHistoria` varchar(20) NOT NULL,
  `tarjetaHistoria` varchar(128) NOT NULL,
  `fechaHistoria` datetime DEFAULT NULL,
  `cantidadHistoria` tinyint(2) DEFAULT NULL,
...
INSERT INTO `historialsolicitud` VALUES (2,'::1','48977807939718','2020-04-29 00:00:00',2);
